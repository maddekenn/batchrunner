...
public class UnusedPresentationGroupFinder extends MetadataFinder implements Finder {
	...
	private boolean recordIsReferedToFromOtherRecords(JsonObject record) {
